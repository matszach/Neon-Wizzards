...
PROJECTILE_ICE_MISSILE = create_image_table(f'{PROJECTILES_SPRITESETS_PATH}ice_prj{FILE_EXTENSION}', 0, 4, 0, 1, SSIZE)
PROJECTILE_ICE_STAR = create_image_table(f'{PROJECTILES_SPRITESETS_PATH}ice_prj{FILE_EXTENSION}', 0, 4, 1, 2, SSIZE)
PROJECTILE_ICE_ORB = create_image_table(f'{PROJECTILES_SPRITESETS_PATH}ice_prj{FILE_EXTENSION}', 0, 4, 2, 3, SSIZE)
PROJECTILE_ICE_SPIKE = create_image_table(f'{PROJECTILES_SPRITESETS_PATH}ice_prj{FILE_EXTENSION}', 0, 4, 3, 4, SSIZE)
PROJECTILE_ICE_CRESCENT = create_image_table(f'{PROJECTILES_SPRITESETS_PATH}ice_prj{FILE_EXTENSION}', 0, 4, 4, 5, SSIZE)
